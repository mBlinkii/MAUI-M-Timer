...
Data.entries = {
    {
        ...
        updates = {
            ...
            "Demo mode now shows the Enemy Forces bar at a random percentage (5/30/50/65/95%) and, with Splits enabled, a random best time (5/12/20/28 min) each time it is turned on, so the different display states can be styled.",
        },
    },
    {
        version = "1.2.0",
